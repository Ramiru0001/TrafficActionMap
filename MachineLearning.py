...
if __name__ == "__main__":
    ...
    try:
        ...
        for (road_shape, cluster_label), group in clustered_data.groupby(['road_shape', 'cluster']):
            ...
            args_list.append((road_shape, cluster_label, group, cluster_polygon, accident_tree, accident_points_list,weather_distribution_overall, date_min_timestamp, date_max_timestamp,hour_distribution,minute_distribution,weather_distributions_per_month,weekday_distribution))
